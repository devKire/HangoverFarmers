...
public class GridManager : MonoBehaviour
{
    ...
    public float swapSpeed = 1f; // Velocidade de troca dos tiles
    ...
    IEnumerator MoveTileSmoothly(GameObject tile, Vector3 targetPosition)
    {
        ...
        {
            tile.transform.position = Vector3.Lerp(startingPosition, targetPosition, (elapsedTime / swapSpeed));
